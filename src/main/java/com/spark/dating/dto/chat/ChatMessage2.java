...
//	}
	...
	@Builder
	public ChatMessage2(int sendUser, int chatRoomNo, String message, String sendUserName) {
	...
	public static ChatMessage2 createChatMessage(int senduser, int chatRoomNo, String message) {
		return ChatMessage2.builder().sendUser(senduser).chatRoomNo(chatRoomNo).message(message).build();
	}
